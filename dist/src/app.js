...
const publisher = process.env.USE_SNS === "true"
...
const importHandler = async (req, res) => {
    ...
    try {
        ...
        const now = new Date();
        const videoImport = new VideoImportEntity(video.id_video, user.id_usuario, ProcessingStatusEnum.PENDING, 0, "Importação iniciada", now, now, null, uuidv4());
